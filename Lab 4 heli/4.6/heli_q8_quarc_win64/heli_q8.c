 ...
 * C source code generated on : Sun Nov 17 23:58:15 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.TmpSignalConversionAtToWorkspac[0] = heli_q8_B.PitchTransferFcn;
    heli_q8_B.TmpSignalConversionAtToWorkspac[1] =
      heli_q8_B.ElevationTransferFcn;
    heli_q8_B.TmpSignalConversionAtToWorkspac[2] = heli_q8_B.TravelTransferFcn;
    heli_q8_B.TmpSignalConversionAtToWorkspac[3] = heli_q8_B.Sum;
    ...
    /* Sum: '<S6>/Sum2' */
    rtb_BackmotorSaturation = heli_q8_B.TrigonometricFunction -
    ...
    /* Sum: '<S6>/Sum3' */
    rtb_FrontmotorSaturation = heli_q8_B.Gain1[1] - heli_q8_B.Joystick_gain_y;

    /* SignalConversion: '<S6>/TmpSignal ConversionAtKInport1' incorporates:
     *  Gain: '<S6>/K'
     */
    tmp_0[0] = heli_q8_B.TrigonometricFunction;
    tmp_0[3] = rtb_BackmotorSaturation;
    tmp_0[4] = rtb_FrontmotorSaturation;
    tmp_0[1] = heli_q8_B.Gain1[0];
    ...
    for (i = 0; i < 2; i++) {
      /* Gain: '<S6>/K' incorporates:
       *  Sum: '<S6>/Sum'
       */
      tmp_2[i] = 0.0;
      for (i_0 = 0; i_0 < 5; i_0++) {
        tmp_2[i] += heli_q8_P.K[(i_0 << 1) + i] * tmp_0[i_0];
      }

      /* Sum: '<S6>/Sum' */
      rtb_Sum[i] = tmp_1[i] - tmp_2[i];
    }
    ...
    heli_q8_B.Fcn = atan(heli_q8_B.Gain2[0] / tmp);

    /* End of Fcn: '<S7>/Fcn' */

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace1Inport1' */
    heli_q8_B.TmpSignalConversionAtToWorksp_g[0] = heli_q8_B.Gain1[0];
    heli_q8_B.TmpSignalConversionAtToWorksp_g[1] = heli_q8_B.Gain1[1];
    heli_q8_B.TmpSignalConversionAtToWorksp_g[2] = heli_q8_B.Gain1[2];
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (4250503545U);
  heli_q8_M->Sizes.checksums[1] = (388555574U);
  heli_q8_M->Sizes.checksums[2] = (9728716U);
  heli_q8_M->Sizes.checksums[3] = (585489304U);
  ...
  heli_q8_M->Sizes.numBlocks = (77);   /* Number of blocks */
