...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Pitch_PWORK;                       /* '<S9>/Pitch' */

  struct {
    void *LoggedData;
  } Elevation_PWORK;                   /* '<S9>/Elevation' */

  struct {
    void *LoggedData;
  } Travel_PWORK;                      /* '<S9>/Travel' */

  struct {
    void *LoggedData;
  } xaxis_PWORK;                       /* '<S10>/x-axis' */

  struct {
    void *LoggedData;
  } yaxis_PWORK;                       /* '<S10>/y-axis' */

  struct {
    void *LoggedData;
  } zaxis_PWORK;                       /* '<S10>/z-axis' */
 ...
 * '<S7>'   : 'heli_q8/plotting and calculations'
 * '<S8>'   : 'heli_q8/plotting and calculations/Conver.'
 * '<S9>'   : 'heli_q8/plotting and calculations/rates imu to workspace'
 * '<S10>'  : 'heli_q8/plotting and calculations/rates imu to workspace1'
 */
