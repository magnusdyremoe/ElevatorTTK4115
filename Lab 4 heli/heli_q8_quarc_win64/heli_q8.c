 ...
 * C source code generated on : Tue Nov 05 20:48:32 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum = heli_q8_P.Constant_Value_c + heli_q8_B.PitchCounttorad;
  ...
  for (i = 0; i < 2; i++) {
    tmp_1 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_1 += heli_q8_P.K[(i_0 << 1) + i] * tmp[i_0];
    }

    tmp_0[i] = heli_q8_B.F[i] - tmp_1;
  }

  /* End of Sum: '<S6>/Sum' */

  /* Sum: '<S6>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.V_s_0 + tmp_0[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2840021278U);
  heli_q8_M->Sizes.checksums[1] = (1464570037U);
  heli_q8_M->Sizes.checksums[2] = (3514098695U);
  heli_q8_M->Sizes.checksums[3] = (3146544047U);
  ...
  heli_q8_M->Sizes.numBlocks = (63);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (20);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (424);/* Sum of parameter "widths" */
  return heli_q8_M;
}
