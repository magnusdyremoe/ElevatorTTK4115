...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Travel_PWORK;                      /* '<S7>/Travel' */

  struct {
    void *LoggedData;
  } Pitch_PWORK;                       /* '<S7>/Pitch' */

  struct {
    void *LoggedData;
  } Elevation_PWORK;                   /* '<S7>/Elevation' */

  struct {
    void *LoggedData;
  } Pitch_PWORK_f;                     /* '<S8>/Pitch' */

  struct {
    void *LoggedData;
  } Elevation_PWORK_n;                 /* '<S8>/Elevation' */

  struct {
    void *LoggedData;
  } Travel_PWORK_c;                    /* '<S8>/Travel' */

  struct {
    void *LoggedData;
  } xaxis_PWORK;                       /* '<S9>/x-axis' */

  struct {
    void *LoggedData;
  } yaxis_PWORK;                       /* '<S9>/y-axis' */

  struct {
    void *LoggedData;
  } zaxis_PWORK;                       /* '<S9>/z-axis' */
...
struct P_heli_q8_T_ {
  ...
  real_T Gain2_Gain[9];                /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                        ...
                                        */
  real_T Constant_Value_c;             /* Expression: 0.2
 ...
 * '<S7>'   : 'heli_q8/Subsystem'
 * '<S8>'   : 'heli_q8/rates imu to workspace'
 * '<S9>'   : 'heli_q8/rates imu to workspace1'
 */
