 ...
 * C source code generated on : Wed Nov 13 06:33:49 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* Integrator: '<S10>/  ' */
  heli_q8_B.u = heli_q8_X._CSTATE;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }

  /* Integrator: '<S9>/    ' */
  heli_q8_B.u_p = heli_q8_X._CSTATE_k;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }

  /* Integrator: '<S8>/      ' */
  heli_q8_B.u_l = heli_q8_X._CSTATE_p;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S1>/Subtract'
     */
    rtb_BackmotorSaturation = (heli_q8_B.Joystick_gain_y +
      heli_q8_B.Joystick_gain_x) * heli_q8_P.Backgain_Gain;

    /* Gain: '<S1>/Front gain' incorporates:
     *  Sum: '<S1>/Add'
     */
    rtb_FrontmotorSaturation = (heli_q8_B.Joystick_gain_y -
      heli_q8_B.Joystick_gain_x) * heli_q8_P.Frontgain_Gain;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S8>/K_3_nesten' */
    heli_q8_B.K_3_nesten = heli_q8_P.K_3_nesten * heli_q8_B.Joystick_gain_y;
  }

  /* Integrator: '<S8>/     ' */
  heli_q8_B.u_pk = heli_q8_X._CSTATE_d;

  /* Product: '<S8>/Product' */
  heli_q8_B.Product = heli_q8_B.K_3_nesten * heli_q8_B.u;

  /* Integrator: '<S9>/   ' */
  heli_q8_B.u_c = heli_q8_X._CSTATE_e;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S9>/K_2' incorporates:
     *  Constant: '<S9>/Constant'
     *  Sum: '<S9>/Sum'
     */
    heli_q8_B.K_2 = (heli_q8_B.Joystick_gain_y - heli_q8_P.V_s_0) *
      heli_q8_P.K_2;
  ...
  /* Integrator: '<S10>/ ' */
  heli_q8_B.u_k = heli_q8_X._CSTATE_j;
...
void heli_q8_derivatives(void)
{
  ...
  /* Derivatives for Integrator: '<S10>/  ' */
  _rtXdot->_CSTATE = heli_q8_B.u_k;

  /* Derivatives for Integrator: '<S9>/    ' */
  _rtXdot->_CSTATE_k = heli_q8_B.u_c;

  /* Derivatives for Integrator: '<S8>/      ' */
  _rtXdot->_CSTATE_p = heli_q8_B.u_pk;
  ...
  /* Derivatives for Integrator: '<S8>/     ' */
  _rtXdot->_CSTATE_d = heli_q8_B.Product;

  /* Derivatives for Integrator: '<S9>/   ' */
  _rtXdot->_CSTATE_e = heli_q8_B.K_2;

  /* Derivatives for Integrator: '<S10>/ ' */
  _rtXdot->_CSTATE_j = heli_q8_B.K_1;
...
void heli_q8_initialize(void)
{
  ...
  /* InitializeConditions for Integrator: '<S10>/  ' */
  heli_q8_X._CSTATE = heli_q8_P._IC;

  /* InitializeConditions for Integrator: '<S9>/    ' */
  heli_q8_X._CSTATE_k = heli_q8_P._IC_a;

  /* InitializeConditions for Integrator: '<S8>/      ' */
  heli_q8_X._CSTATE_p = heli_q8_P._IC_k;
  ...
  /* InitializeConditions for Integrator: '<S8>/     ' */
  heli_q8_X._CSTATE_d = heli_q8_P._IC_b;

  /* InitializeConditions for Integrator: '<S9>/   ' */
  heli_q8_X._CSTATE_e = heli_q8_P._IC_g;

  /* InitializeConditions for Integrator: '<S10>/ ' */
  heli_q8_X._CSTATE_j = heli_q8_P._IC_i;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2147783680U);
  heli_q8_M->Sizes.checksums[1] = (970783583U);
  heli_q8_M->Sizes.checksums[2] = (2601743783U);
  heli_q8_M->Sizes.checksums[3] = (1555613787U);
