...
typedef struct {
  ...
  real_T u_p;                          /* '<S8>/     ' */
  real_T K_3_nesten;                   /* '<S8>/K_3_nesten' */
...
/* State disabled  */
typedef struct {
  boolean_T _CSTATE;                   /* '<S9>/    ' */
  boolean_T _CSTATE_p;                 /* '<S8>/      ' */
  boolean_T _CSTATE_n;                 /* '<S10>/  ' */
  ...
  boolean_T _CSTATE_d;                 /* '<S8>/     ' */
  boolean_T _CSTATE_e;                 /* '<S9>/   ' */
  boolean_T _CSTATE_j;                 /* '<S10>/ ' */
...
struct P_heli_q8_T_ {
  ...
  real_T K_1;                          /* Variable: K_1
                                        * Referenced by: '<S10>/K_1'
                                        */
  real_T K_2;                          /* Variable: K_2
                                        * Referenced by: '<S9>/K_2'
                                        */
  real_T K_3_nesten;                   /* Variable: K_3_nesten
                                        * Referenced by: '<S8>/K_3_nesten'
                                        */
  real_T V_s_0;                        /* Variable: V_s_0
                                        * Referenced by: '<Root>/v_s_0'
                                        */
  ...
  real_T _IC;                          /* Expression: 0
                                        * Referenced by: '<S9>/    '
                                        */
  real_T _IC_k;                        /* Expression: 0
                                        * Referenced by: '<S8>/      '
                                        */
  real_T _IC_a;                        /* Expression: 0
                                        * Referenced by: '<S10>/  '
                                        */
  ...
  real_T BackmotorSaturation_LowerSat; /* Expression: -5
                                        * Referenced by: '<S3>/Back motor: Saturation'
                                        */
  real_T _IC_b;                        /* Expression: 0
                                        * Referenced by: '<S8>/     '
                                        */
  real_T _IC_g;                        /* Expression: 0
                                        * Referenced by: '<S9>/   '
                                        */
  real_T _IC_i;                        /* Expression: 0
                                        * Referenced by: '<S10>/ '
                                        */
 ...
 * '<S6>'   : 'heli_q8/Subsystem1'
 * '<S7>'   : 'heli_q8/Elevation controller/Elevation controller'
 * '<S8>'   : 'heli_q8/Subsystem1/Subsystem'
 * '<S9>'   : 'heli_q8/Subsystem1/e-double-integrator'
 * '<S10>'  : 'heli_q8/Subsystem1/p-double-integrator'
 */
