 ...
 * C source code generated on : Mon Nov 18 00:13:59 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    rtb_BackmotorSaturation = heli_q8_DW.UnitDelay1_DSTATE[0] -
     ...
     *  UnitDelay: '<Root>/Unit Delay1'
     */
    rtb_FrontmotorSaturation = heli_q8_DW.UnitDelay1_DSTATE[3] -
     ...
     *  UnitDelay: '<Root>/Unit Delay1'
     */
    tmp[2] = heli_q8_DW.UnitDelay1_DSTATE[3];
    tmp[3] = rtb_BackmotorSaturation;
    tmp[4] = rtb_FrontmotorSaturation;
    tmp[0] = heli_q8_DW.UnitDelay1_DSTATE[0];

    /* Gain: '<S7>/F' incorporates:
     *  SignalConversion: '<S7>/TmpSignal ConversionAtFInport1'
     *  Sum: '<S7>/Sum'
     */
    tmp_0[0] = heli_q8_P.F[0] * heli_q8_B.Joystick_gain_x + heli_q8_P.F[2] *
      heli_q8_B.Joystick_gain_y;
     ...
     *  UnitDelay: '<Root>/Unit Delay1'
     */
    tmp[1] = heli_q8_DW.UnitDelay1_DSTATE[1];

    /* Gain: '<S7>/F' incorporates:
     *  SignalConversion: '<S7>/TmpSignal ConversionAtFInport1'
     *  Sum: '<S7>/Sum'
     */
    tmp_0[1] = heli_q8_P.F[1] * heli_q8_B.Joystick_gain_x;
    tmp_0[1] += heli_q8_P.F[3] * heli_q8_B.Joystick_gain_y;
    for (i = 0; i < 2; i++) {
     ...
     *  Sum: '<S8>/Sum'
     */
    /* MATLAB Function 'Open Loopestimator/MATLAB Function': '<S10>:1' */
    /* '<S10>:1:2' */
    tmp_5 = heli_q8_B.Sum1 - heli_q8_P.V_s_0;
    ...
    for (i = 0; i < 6; i++) {
      tmp_2[i] = 0.0;
      tmp_3[i] = 0.0;
      tmp_3[i] += heli_q8_P.B_d[i] * tmp_5;
      tmp_3[i] += heli_q8_P.B_d[i + 6] * rtb_Sum[1];
      for (i_0 = 0; i_0 < 6; i_0++) {
        tmp_2[i] += heli_q8_P.A_d[6 * i_0 + i] * heli_q8_DW.UnitDelay_DSTATE[i_0];
        tmp_4[i + 6 * i_0] = 0.0;
        for (i_1 = 0; i_1 < 6; i_1++) {
          tmp_4[i + 6 * i_0] += heli_q8_P.A_d[6 * i_1 + i] *
            heli_q8_DW.UnitDelay2_DSTATE[6 * i_0 + i_1];
        }
      }

      heli_q8_B.x_next[i] = tmp_2[i] + tmp_3[i];
    }
    ...
    for (i = 0; i < 6; i++) {
      for (i_0 = 0; i_0 < 6; i_0++) {
        tmp_5 = 0.0;
        for (i_1 = 0; i_1 < 6; i_1++) {
          tmp_5 += tmp_4[6 * i_1 + i] * heli_q8_P.A_d[6 * i_1 + i_0];
        }

        heli_q8_B.P_bar[i + 6 * i_0] = heli_q8_P.Q_d[6 * i_0 + i] + tmp_5;
      }
    }
  }
}
...
void heli_q8_update0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    for (i = 0; i < 6; i++) {
      heli_q8_DW.UnitDelay1_DSTATE[i] = heli_q8_B.x_next[i];
    }

    /* End of Update for UnitDelay: '<Root>/Unit Delay1' */

    /* Update for UnitDelay: '<S8>/Unit Delay2' */
    memcpy(&heli_q8_DW.UnitDelay2_DSTATE[0], &heli_q8_B.P_bar[0], 36U * sizeof
           (real_T));
...
void heli_q8_initialize(void)
{
...

  {
    ...
    for (i = 0; i < 6; i++) {
      heli_q8_DW.UnitDelay1_DSTATE[i] = heli_q8_P.UnitDelay1_InitialCondition[i];
    }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1006877619U);
  heli_q8_M->Sizes.checksums[1] = (612331158U);
  heli_q8_M->Sizes.checksums[2] = (270504053U);
  heli_q8_M->Sizes.checksums[3] = (3696629747U);
  ...
  heli_q8_M->Sizes.numBlocks = (76);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (18);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (556);/* Sum of parameter "widths" */
  return heli_q8_M;
}
