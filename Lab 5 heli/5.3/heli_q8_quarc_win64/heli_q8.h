...
typedef struct {
  ...
  real_T P_bar[36];                    /* '<S8>/MATLAB Function' */
  real_T x_next[6];                    /* '<S8>/MATLAB Function' */
...
typedef struct {
  ...
  real_T UnitDelay2_DSTATE[36];        /* '<S8>/Unit Delay2' */
...
struct P_heli_q8_T_ {
  ...
  real_T ElevationTransferFcn_D;       /* Computed Parameter: ElevationTransferFcn_D
                                        * Referenced by: '<S4>/Elevation: Transfer Fcn'
                                        */
  real_T UnitDelay1_InitialCondition[6];/* Expression: [0,0,0,0,0,0]
 ...
 * '<S8>'   : 'heli_q8/Open Loopestimator'
 * '<S9>'   : 'heli_q8/crosscheck correct outputs!!!'
 * '<S10>'  : 'heli_q8/Open Loopestimator/MATLAB Function'
 */
