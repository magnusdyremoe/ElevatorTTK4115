...
typedef struct {
  ...
  real_T UnitDelay[8];                 /* '<Root>/Unit Delay' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } elevationrateandtravelrate_PWOR;   /* '<Root>/elevation rate and travel rate' */

  struct {
    void *LoggedData;
  } heisann_PWORK;                     /* '<Root>/heisann' */

  struct {
    void *LoggedData;
  } heisann1_PWORK;                    /* '<Root>/heisann1' */

  struct {
    void *LoggedData;
  } magnetometer_PWORK;                /* '<Root>/magnetometer' */

  struct {
    void *LoggedData;
  } newdata_PWORK;                     /* '<Root>/new data' */

  struct {
    void *LoggedData;
  } temp_PWORK;                        /* '<Root>/temp' */
  ...
  struct {
    void *LoggedData[5];
  } accelerometer1_PWORK;              /* '<Root>/accelerometer1' */
...
struct P_heli_q8_T_ {
  ...
  real_T Gain2_Gain[9];                /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                        ...
                                        */
  real_T poffset_Value;                /* Expression: 0.125
                                        * Referenced by: '<S3>/p offset'
                                        */
  real_T PitchCounttorad_Gain;         /* Expression: -2*pi /4096
                                        * Referenced by: '<S3>/Pitch: Count to rad'
                                        */
  real_T eoffset_Value;                /* Expression: 0
                                        * Referenced by: '<S3>/e offset '
                                        */
  ...
  real_T Gain1_Gain_n;                 /* Expression: 1
                                        ...
                                        */
  real_T V_s_0_Value;                  /* Expression: 8
                                        * Referenced by: '<S6>/V_s_0 '
                                        */
 ...
 * '<S4>'   : 'heli_q8/IMU'
 * '<S5>'   : 'heli_q8/Joystick'
 * '<S6>'   : 'heli_q8/Lab 3 - LQR-regulator'
 * '<S7>'   : 'heli_q8/MATLAB Function'
 */
