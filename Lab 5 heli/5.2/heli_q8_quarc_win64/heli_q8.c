 ...
 * C source code generated on : Mon Nov 18 00:08:20 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_FrontmotorSaturation = heli_q8_B.RateTransitionx -
     ...
     *  Gain: '<S6>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * rtb_FrontmotorSaturation *
      heli_q8_P.Joystick_gain_x;

    /* Sum: '<S7>/Sum2' incorporates:
     *  UnitDelay: '<Root>/Unit Delay1'
     */
    rtb_FrontmotorSaturation = heli_q8_DW.UnitDelay1_DSTATE[0] -
     ...
     *  UnitDelay: '<Root>/Unit Delay1'
     */
    rtb_BackmotorSaturation = heli_q8_DW.UnitDelay1_DSTATE[3] -
    ...
    tmp[3] = rtb_FrontmotorSaturation;
    tmp[4] = rtb_BackmotorSaturation;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3954911527U);
  heli_q8_M->Sizes.checksums[1] = (2126589147U);
  heli_q8_M->Sizes.checksums[2] = (328601747U);
  heli_q8_M->Sizes.checksums[3] = (3824238024U);
  ...
  heli_q8_M->Sizes.numBlocks = (74);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (17);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (484);/* Sum of parameter "widths" */
  return heli_q8_M;
}
