...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&heli_q8_B.RateTransitionx), 0, 0, 26 },

  { (char_T *)(&heli_q8_B.StreamCall1_o2), 3, 0, 1 }
  ,

  { (char_T *)(&heli_q8_DW.UnitDelay1_DSTATE[0]), 0, 0, 80 },
  ...
  { (char_T *)(&heli_q8_DW.ToWorkspace_PWORK.LoggedData), 11, 0, 13 },
