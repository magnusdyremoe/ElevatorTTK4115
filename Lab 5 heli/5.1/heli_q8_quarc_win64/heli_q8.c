 ...
 * C source code generated on : Mon Nov 11 22:18:32 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.V_s_0 = heli_q8_P.V_s_0;
  ...
  /* SignalConversion: '<S6>/TmpSignal ConversionAtKInport1' incorporates:
  ...
  tmp[3] = heli_q8_X.Integrator1_CSTATE;
  tmp[4] = heli_q8_X.Integrator_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      u0 += heli_q8_P.K[(i_0 << 1) + i] * tmp[i_0];
    }

    rtb_Sum[i] = heli_q8_B.F[i] - u0;
  }

  /* End of Sum: '<S6>/Sum' */

  /* Sum: '<S6>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.V_s_0 + rtb_Sum[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Constant: '<S7>/A_d' */
   ...
   *  Sum: '<S7>/Sum'
   */
  /* MATLAB Function 'Open Loopestimator/MATLAB Function': '<S11>:1' */
  /* '<S11>:1:2' */
  u0 = heli_q8_B.Sum1 - heli_q8_B.Constant;
  ...
  for (i = 0; i < 6; i++) {
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_0[i] += heli_q8_B.A_d[6 * i_0 + i] * heli_q8_B.UnitDelay[i_0];
    }

    tmp_1[i] = 0.0;
    tmp_1[i] += heli_q8_B.B_d[i] * u0;
    tmp_1[i] += heli_q8_B.B_d[i + 6] * rtb_Sum[1];
    heli_q8_B.x_next[i] = tmp_0[i] + tmp_1[i];
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    for (i = 0; i < 3; i++) {
      ...
      /* SignalConversion: '<S10>/TmpSignal ConversionAtTo Workspace1Inport1' */
      heli_q8_B.TmpSignalConversionAtToWorksp_g[i] = heli_q8_B.Gain1[i];
    }
    ...
    /* Fcn: '<S10>/Fcn' */
    u0 = rt_powd_snf(heli_q8_B.Gain2[1], 2.0) + rt_powd_snf(heli_q8_B.Gain2[2],
      2.0);
    if (u0 < 0.0) {
      u0 = -sqrt(-u0);
    } else {
    ...
    heli_q8_B.Fcn = atan(heli_q8_B.Gain2[0] / u0);

    /* End of Fcn: '<S10>/Fcn' */

    /* SignalConversion: '<S10>/TmpSignal ConversionAtTo Workspace1Inport1' */
    heli_q8_B.TmpSignalConversionAtToWorksp_g[3] =
      heli_q8_B.TrigonometricFunction;
    heli_q8_B.TmpSignalConversionAtToWorksp_g[4] = heli_q8_B.Fcn;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S6>/Sum2' */
    heli_q8_B.e_p_dot = heli_q8_B.Sum - heli_q8_B.Joystick_gain_x;
  }

  /* Sum: '<S6>/Sum3' */
  heli_q8_B.e_e_dot = heli_q8_B.ElevationTransferFcn - heli_q8_B.Joystick_gain_y;
}
...
void heli_q8_update0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    for (i = 0; i < 6; i++) {
      heli_q8_DW.UnitDelay_DSTATE[i] = heli_q8_B.x_next[i];
    }
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->Integrator1_CSTATE = heli_q8_B.e_p_dot;

  /* Derivatives for Integrator: '<S6>/Integrator' */
  _rtXdot->Integrator_CSTATE = heli_q8_B.e_e_dot;
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2498276400U);
  heli_q8_M->Sizes.checksums[1] = (2495241581U);
  heli_q8_M->Sizes.checksums[2] = (1291321366U);
  heli_q8_M->Sizes.checksums[3] = (1163412629U);
...

  {
    ...
    heli_q8_B.e_p_dot = 0.0;
    heli_q8_B.e_e_dot = 0.0;
  }
  ...
  heli_q8_M->Sizes.numBlocks = (91);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (32);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (489);/* Sum of parameter "widths" */
  return heli_q8_M;
}
