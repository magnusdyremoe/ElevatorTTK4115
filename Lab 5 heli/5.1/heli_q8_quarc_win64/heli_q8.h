...
typedef struct {
  ...
  real_T UnitDelay[6];                 /* '<S7>/Unit Delay' */
  ...
  real_T Fcn;                          /* '<S10>/Fcn' */
  real_T TmpSignalConversionAtToWorksp_g[5];
  ...
  real_T e_p_dot;                      /* '<S6>/Sum2' */
  real_T e_e_dot;                      /* '<S6>/Sum3' */
  real_T x_next[6];                    /* '<S7>/MATLAB Function' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Travel_PWORK;                      /* '<S8>/Travel' */

  struct {
    void *LoggedData;
  } Pitch_PWORK;                       /* '<S8>/Pitch' */

  struct {
    void *LoggedData;
  } Elevation_PWORK;                   /* '<S8>/Elevation' */
  ...
  struct {
    void *LoggedData;
  } ToWorkspace1_PWORK_b;              /* '<S10>/To Workspace1' */

  struct {
    void *LoggedData;
  } Pitch_PWORK_f;                     /* '<S12>/Pitch' */

  struct {
    void *LoggedData;
  } Elevation_PWORK_n;                 /* '<S12>/Elevation' */

  struct {
    void *LoggedData;
  } Travel_PWORK_c;                    /* '<S12>/Travel' */

  struct {
    void *LoggedData;
  } xaxis_PWORK;                       /* '<S13>/x-axis' */

  struct {
    void *LoggedData;
  } yaxis_PWORK;                       /* '<S13>/y-axis' */

  struct {
    void *LoggedData;
  } zaxis_PWORK;                       /* '<S13>/z-axis' */
 ...
 * '<S4>'   : 'heli_q8/IMU'
 * '<S5>'   : 'heli_q8/Joystick'
 * '<S6>'   : 'heli_q8/Lab 3.3 - LQR-regulator with integral effect'
 * '<S7>'   : 'heli_q8/Open Loopestimator'
 * '<S8>'   : 'heli_q8/Subsystem'
 * '<S9>'   : 'heli_q8/Subsystem1'
 * '<S10>'  : 'heli_q8/plotting and calculations'
 * '<S11>'  : 'heli_q8/Open Loopestimator/MATLAB Function'
 * '<S12>'  : 'heli_q8/plotting and calculations/rates imu to workspace'
 * '<S13>'  : 'heli_q8/plotting and calculations/rates imu to workspace1'
 */
