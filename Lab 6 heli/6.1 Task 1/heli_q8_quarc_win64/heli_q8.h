...
typedef struct {
  ...
  real_T pitch;                        /* '<S16>/Trigonometric Function' */
  real_T elevation;                    /* '<S16>/Fcn' */
  real_T Constant;                     /* '<S9>/Constant' */
  real_T TmpSignalConversionAtC_dInport1[6];
  real_T Switch[6];                    /* '<S10>/Switch' */
  real_T Switch1[36];                  /* '<S10>/Switch1' */
...
typedef struct {
  ...
  real_T UnitDelay2_DSTATE[36];        /* '<S6>/Unit Delay2' */
  real_T UnitDelay_DSTATE_m[6];        /* '<S6>/Unit Delay' */
  ...
  struct {
    void *LoggedData;
  } ElevationeScoperads_PWORK;         /* '<S3>/Elevation (e): Scope [rad//s]' */

  struct {
    void *LoggedData;
  } ElevationeScoperad_PWORK;          /* '<S3>/Elevation (e): Scope [rad]' */

  struct {
    void *LoggedData;
  } PtichprateScoperads_PWORK;         /* '<S3>/Ptich (p) rate: Scope [rad//s]' */

  struct {
    void *LoggedData;
  } TravellambdaScoperad_PWORK;        /* '<S3>/Travel (lambda): Scope [rad]' */

  struct {
    void *LoggedData;
  } TravelratelambdaScoperads_PWORK;   /* '<S3>/Travel rate (lambda): Scope [rad//s]' */

  void *HILWriteAnalog_PWORK;          /* '<S3>/HIL Write Analog' */
  struct {
    void *LoggedData;
  } PitchpScoperad_PWORK;              /* '<S3>/Pitch (p): Scope [rad]' */

  struct {
    void *LoggedData;
  } Connected_PWORK;                   /* '<S4>/Connected' */
...
struct P_heli_q8_T_ {
  real_T A_d[36];                      /* Variable: A_d
                                        * Referenced by: '<S11>/A_d'
                                        */
  real_T B_d[12];                      /* Variable: B_d
                                        * Referenced by: '<S11>/B_d'
                                        */
 ...
 * '<S2>'   : 'heli_q8/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S3>'   : 'heli_q8/Heli 3D'
 * '<S4>'   : 'heli_q8/IMU'
 * '<S5>'   : 'heli_q8/Joystick'
 * '<S6>'   : 'heli_q8/Kalman-Filter'
 * '<S7>'   : 'heli_q8/Lab 3.3 - LQR-regulator with integral effect'
 * '<S8>'   : 'heli_q8/Rearrangement'
 * '<S9>'   : 'heli_q8/Subsystem'
 * '<S10>'  : 'heli_q8/Kalman-Filter/Correction'
 * '<S11>'  : 'heli_q8/Kalman-Filter/Open Loopestimator'
 * '<S12>'  : 'heli_q8/Kalman-Filter/Correction/MATLAB Function'
 * '<S13>'  : 'heli_q8/Kalman-Filter/Correction/MATLAB Function1'
 * '<S14>'  : 'heli_q8/Kalman-Filter/Correction/MATLAB Function2'
 * '<S15>'  : 'heli_q8/Kalman-Filter/Open Loopestimator/MATLAB Function'
 * '<S16>'  : 'heli_q8/Subsystem/crosscheck correct outputs!!!'
 */
