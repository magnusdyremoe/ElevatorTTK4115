...
typedef struct {
  ...
  real_T TmpSignalConversionAtToWorkspac[6];
  ...
  real_T pitch;                        /* '<S17>/Trigonometric Function' */
  real_T elevation;                    /* '<S17>/Fcn' */
  real_T Constant_k;                   /* '<S10>/Constant' */
  real_T TmpSignalConversionAtC_dInport1[6];
  real_T C_d[5];                       /* '<S11>/C_d' */
  real_T UnitDelay2[36];               /* '<S7>/Unit Delay2' */
  real_T Constant_kl;                  /* '<S12>/Constant' */
  real_T A_d[36];                      /* '<S12>/A_d' */
  real_T B_d[12];                      /* '<S12>/B_d' */
  real_T Q_d[36];                      /* '<S12>/Q_d' */
  real_T UnitDelay_p[6];               /* '<S7>/Unit Delay' */
  real_T u[30];                        /* '<S11>/ ' */
  real_T Constant_f[25];               /* '<S11>/Constant' */
  real_T Switch_l[6];                  /* '<S11>/Switch' */
  real_T Switch1[36];                  /* '<S11>/Switch1' */
  real_T euler_rates[3];               /* '<Root>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
  uint8_T StreamCall1_o2;              /* '<S5>/Stream Call1' */
  boolean_T StreamRead1_o3;            /* '<S5>/Stream Read1' */
} B_heli_q8_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T UnitDelay_DSTATE[6];          /* '<Root>/Unit Delay' */
  real_T UnitDelay2_DSTATE[36];        /* '<S7>/Unit Delay2' */
  real_T UnitDelay_DSTATE_m[6];        /* '<S7>/Unit Delay' */
  ...
  struct {
    void *LoggedData;
  } ElevationeScoperads_PWORK;         /* '<S4>/Elevation (e): Scope [rad//s]' */

  struct {
    void *LoggedData;
  } ElevationeScoperad_PWORK;          /* '<S4>/Elevation (e): Scope [rad]' */

  struct {
    void *LoggedData;
  } PtichprateScoperads_PWORK;         /* '<S4>/Ptich (p) rate: Scope [rad//s]' */

  struct {
    void *LoggedData;
  } TravellambdaScoperad_PWORK;        /* '<S4>/Travel (lambda): Scope [rad]' */

  struct {
    void *LoggedData;
  } TravelratelambdaScoperads_PWORK;   /* '<S4>/Travel rate (lambda): Scope [rad//s]' */

  void *HILWriteAnalog_PWORK;          /* '<S4>/HIL Write Analog' */
  struct {
    void *LoggedData;
  } PitchpScoperad_PWORK;              /* '<S4>/Pitch (p): Scope [rad]' */
...
struct P_heli_q8_T_ {
  real_T A_d[36];                      /* Variable: A_d
                                        * Referenced by: '<S12>/A_d'
                                        */
  real_T B_d[12];                      /* Variable: B_d
                                        * Referenced by: '<S12>/B_d'
                                        */
  ...
  real_T K[6];                         /* Variable: K
                                        * Referenced by: '<S8>/K'
                                        */
  real_T P_init[36];                   /* Variable: P_init
                                        * Referenced by: '<S7>/Unit Delay2'
                                        */
  real_T Q_d[36];                      /* Variable: Q_d
                                        * Referenced by: '<S12>/Q_d'
                                        */
  real_T R[25];                        /* Variable: R
                                        * Referenced by: '<S11>/Constant'
                                        */
  real_T V_s_0;                        /* Variable: V_s_0
                                        * Referenced by:
                                        *   '<S8>/V_s_0 '
                                        *   '<S12>/Constant'
                                        */
  ...
  real_T Constant_Value_l;             /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_e;            /* Expression: 65
  ...
  real_T Constant_Value_b;             /* Expression: 0
                                        ...
                                        */
  real_T UnitDelay_InitialCondition_h[6];/* Expression: [0,0,0,0,0,0]
 ...
 * '<S2>'   : 'heli_q8/Delay 6sec'
 * '<S3>'   : 'heli_q8/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S4>'   : 'heli_q8/Heli 3D'
 * '<S5>'   : 'heli_q8/IMU'
 * '<S6>'   : 'heli_q8/Joystick'
 * '<S7>'   : 'heli_q8/Kalman-Filter'
 * '<S8>'   : 'heli_q8/Lab 3 - LQR-regulator'
 * '<S9>'   : 'heli_q8/Rearrangement'
 * '<S10>'  : 'heli_q8/Subsystem'
 * '<S11>'  : 'heli_q8/Kalman-Filter/Correction'
 * '<S12>'  : 'heli_q8/Kalman-Filter/Open Loopestimator'
 * '<S13>'  : 'heli_q8/Kalman-Filter/Correction/MATLAB Function'
 * '<S14>'  : 'heli_q8/Kalman-Filter/Correction/MATLAB Function1'
 * '<S15>'  : 'heli_q8/Kalman-Filter/Correction/MATLAB Function2'
 * '<S16>'  : 'heli_q8/Kalman-Filter/Open Loopestimator/MATLAB Function'
 * '<S17>'  : 'heli_q8/Subsystem/crosscheck correct outputs!!!'
 */
