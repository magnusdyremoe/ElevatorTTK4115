  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(19).dtTransOffset = 195;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q8_B.UnitDelay_p
	  section.data(33).logicalSrcIdx = 32;
	  section.data(33).dtTransOffset = 168;
	
	  ;% heli_q8_B.u
	  section.data(34).logicalSrcIdx = 33;
	  section.data(34).dtTransOffset = 174;
	
	  ;% heli_q8_B.Constant_f
	  section.data(35).logicalSrcIdx = 34;
	  section.data(35).dtTransOffset = 204;
	
	  ;% heli_q8_B.Switch_l
	  section.data(36).logicalSrcIdx = 35;
	  section.data(36).dtTransOffset = 229;
	
	  ;% heli_q8_B.Switch1
	  section.data(37).logicalSrcIdx = 36;
	  section.data(37).dtTransOffset = 235;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.Scope_PWORK_a.LoggedData
  ...
  targMap.checksum0 = 3196072597;
  targMap.checksum1 = 1729356589;
  targMap.checksum2 = 304610011;
  targMap.checksum3 = 3332215865;
