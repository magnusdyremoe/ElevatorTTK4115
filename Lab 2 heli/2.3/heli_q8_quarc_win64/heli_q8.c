...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S6>/Sum'
     */
    heli_q8_B.Gain = (heli_q8_P.p_ref_Value - heli_q8_B.Sum) * heli_q8_P.K_pp;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Constant: '<S1>/e_ref'
     */
    rtb_DeadZoney = heli_q8_P.e_ref_Value - heli_q8_B.ElevationCounttorad;
   ...
   *  Sum: '<S7>/Sum'
   */
  heli_q8_B.Sum_i = ((heli_q8_X.Integrator_CSTATE + heli_q8_B.K_ep) -
   ...
   *  Sum: '<S6>/Sum1'
   */
  rtb_Backgain = (heli_q8_B.Gain - heli_q8_P.K_pd * heli_q8_B.PitchTransferFcn)
   ...
   *  Sum: '<S2>/Add'
   */
  u0 = (heli_q8_B.Sum_i - rtb_Backgain) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S2>/Subtract'
   */
  u0 = (heli_q8_B.Sum_i + rtb_Backgain) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3571271518U);
  heli_q8_M->Sizes.checksums[1] = (1534093263U);
  heli_q8_M->Sizes.checksums[2] = (3643477876U);
  heli_q8_M->Sizes.checksums[3] = (1672553989U);
