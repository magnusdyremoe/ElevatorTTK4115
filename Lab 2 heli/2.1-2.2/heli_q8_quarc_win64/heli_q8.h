 ...
 * C source code generated on : Sun Nov 17 22:24:23 2019
 *
...
struct P_heli_q8_T_ {
  ...
  real_T V_s_0;                        /* Variable: V_s_0
                                        ...
                                        */
  real_T eq;                           /* Variable: eq
                                        * Referenced by: '<S1>/e_ref'
                                        */
  ...
  real_T PitchCounttorad_Gain;         /* Expression: -2*pi /4096
                                        ...
                                        */
  real_T p_ref_Value;                  /* Expression: 0
 ...
 *
 * '<Root>' : 'heli_q8'
 * '<S1>'   : 'heli_q8/Controllers for elevation and pitch'
 * '<S2>'   : 'heli_q8/Conversion'
 * '<S3>'   : 'heli_q8/Heli 3D'
 * '<S4>'   : 'heli_q8/Joystick'
 * '<S5>'   : 'heli_q8/Controllers for elevation and pitch/Elevation controller'
 * '<S6>'   : 'heli_q8/Controllers for elevation and pitch/Pitch controller'
 * '<S7>'   : 'heli_q8/Controllers for elevation and pitch/Elevation controller/Elevation controller'
 */
