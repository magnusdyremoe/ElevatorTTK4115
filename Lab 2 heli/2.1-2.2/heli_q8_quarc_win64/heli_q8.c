...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Constant: '<S1>/e_ref'
     */
    rtb_DeadZoney = heli_q8_P.eq - heli_q8_B.ElevationCounttorad;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1122483153U);
  heli_q8_M->Sizes.checksums[1] = (1840910145U);
  heli_q8_M->Sizes.checksums[2] = (1426338518U);
  heli_q8_M->Sizes.checksums[3] = (3699400078U);
