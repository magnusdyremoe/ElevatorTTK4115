...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } pitch_ref_PWORK;                   /* '<Root>/pitch_ref' */
  ...
  struct {
    void *LoggedData;
  } ElevationeScoperads_PWORK;         /* '<S2>/Elevation (e): Scope [rad//s]' */

  struct {
    void *LoggedData;
  } ElevationeScoperad_PWORK;          /* '<S2>/Elevation (e): Scope [rad]' */

  struct {
    void *LoggedData;
  } PitchpScoperad_PWORK;              /* '<S2>/Pitch (p): Scope [rad]' */

  struct {
    void *LoggedData;
  } PtichprateScoperads_PWORK;         /* '<S2>/Ptich (p) rate: Scope [rad//s]' */

  struct {
    void *LoggedData;
  } TravellambdaScoperad_PWORK;        /* '<S2>/Travel (lambda): Scope [rad]' */

  struct {
    void *LoggedData;
  } TravelratelambdaScoperads_PWORK;   /* '<S2>/Travel rate (lambda): Scope [rad//s]' */
...
struct P_heli_q8_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T eoffset_Value;                /* Expression: -0.41
                                        * Referenced by: '<S2>/e offset '
                                        */
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        * Referenced by: '<S2>/Elevation: Count to rad'
                                        */
  real_T poffset_Value;                /* Expression: -0.129
                                        * Referenced by: '<S2>/p offset'
                                        */
  ...
  real_T ElevationTransferFcn_D;       /* Computed Parameter: ElevationTransferFcn_D
                                        * Referenced by: '<S2>/Elevation: Transfer Fcn'
                                        */
  real_T V_s_0_Value;                  /* Expression: 6
                                        * Referenced by: '<S4>/V_s_0 '
                                        */
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/Joystick'
 * '<S4>'   : 'heli_q8/Lab 3 - LQR-regulator'
 */
