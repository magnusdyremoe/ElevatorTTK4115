 ...
 * C source code generated on : Wed Nov 13 06:39:29 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  for (i = 0; i < 2; i++) {
    rtb_Sum[i] = heli_q8_B.F[i] - ((heli_q8_P.K[i + 2] *
      heli_q8_B.PitchTransferFcn + heli_q8_P.K[i] * heli_q8_B.Sum) +
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1408034134U);
  heli_q8_M->Sizes.checksums[1] = (3589372183U);
  heli_q8_M->Sizes.checksums[2] = (3048886195U);
  heli_q8_M->Sizes.checksums[3] = (526577833U);
  ...
  heli_q8_M->Sizes.numBlocks = (42);   /* Number of blocks */
