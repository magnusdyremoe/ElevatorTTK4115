 ...
 * C source code generated on : Wed Nov 13 06:43:04 2019
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  tmp[3] = heli_q8_B.e_p_dot;
  tmp[4] = heli_q8_B.ElevationTransferFcn - heli_q8_B.Joystick_gain_y;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (260855609U);
  heli_q8_M->Sizes.checksums[1] = (1701163426U);
  heli_q8_M->Sizes.checksums[2] = (1711983008U);
  heli_q8_M->Sizes.checksums[3] = (2565979574U);
  ...
  heli_q8_M->Sizes.numBlocks = (44);   /* Number of blocks */
